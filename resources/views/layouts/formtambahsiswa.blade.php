<div class="col-md-12">
  <div class="form-floating">
    {!! Form::number('nisn',null,['class' => 'form-control', 'id'=>'nomor_induk','placeholder'=>'NISN']) !!}
...
<div class="col-md-12">
  <div class="form-floating">
    {!! Form::text('nama',null,['class' => 'form-control', 'id'=>'validationTooltip03','placeholder'=>'Nama siswa']) !!}
    <label for="floatingName">Nama siswa</label>
  </div>
</div>
<div class="col-md-8">
  <div class="form-floating">
    {!! Form::text('tempat_lahir',null,['class' => 'form-control', 'id'=>'floatingName','placeholder'=>'Tempat Lahir']) !!}
...
<div class="col-md-4">
  <div class="form-floating">
    {!! Form::date('tgl_lahir',null,['class' => 'form-control', 'id'=>'floatingName','placeholder'=>'Tanggal Lahir']) !!}
...
<div class="col-md-6">
  <div class="form-floating">
    {!! Form::email('email',null,['class'=>'form-control','id'=>'floatingEmail','placeholder'=>'Email']) !!}
