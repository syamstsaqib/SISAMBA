                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="post" action="{{ route('login') }}" novalidate>
                        @csrf
                      <div class="col-12">
                        <label for="email" class="form-label">NISN/NIP</label>
                        <div class="input-group has-validation">
                          <input type="number" autocomplete="off" name="nomor_induk" class="form-control" id="nomor_induk" value="{{ old('nomor_induk') }}" placeholder="Masukkan NISN/NIP" required>
                          <div class="invalid-feedback ">Masukkan NISN/NIP Anda.</div>
                        </div>
                      </div>
